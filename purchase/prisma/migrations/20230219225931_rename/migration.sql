/*
  ...
  - You are about to drop the column `aproved` on the `purchases` table. All the data in the column will be lost.
  - Added the required column `approved` to the `purchases` table without a default value. This is not possible if the table is not empty.
